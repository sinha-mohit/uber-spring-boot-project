...
@Service
public class ReviewServiceTmp implements CommandLineRunner {
    ...
    public ReviewServiceTmp(DriverRepository driverRepository, PassengerRepository passengerRepository, ReviewRepository reviewRepository, BookingRepository bookingRepository) {
